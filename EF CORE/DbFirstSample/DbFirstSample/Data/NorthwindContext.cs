...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<CategorySales1996> CategorySales1996s { get; set; }
    ...
    public virtual DbSet<KategoriMenusu> KategoriMenusus { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    {
        modelBuilder.Entity<AktifUrunler>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("AktifUrunler");
        ...
        modelBuilder.Entity<CategorySales1996>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("CategorySales_1996");
        ...
        modelBuilder.Entity<DetailedOrder>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("DetailedOrders");

            entity.Property(e => e.CategoryName).HasMaxLength(15);
            entity.Property(e => e.CompanyName).HasMaxLength(40);
            entity.Property(e => e.Kargo).HasMaxLength(40);
            entity.Property(e => e.OrderDate).HasColumnType("datetime");
            entity.Property(e => e.OrderId).HasColumnName("OrderID");
            entity.Property(e => e.ProductName).HasMaxLength(40);
            entity.Property(e => e.Tedarikçi).HasMaxLength(40);
            entity.Property(e => e.Çalışan).HasMaxLength(31);
            entity.Property(e => e.Ödenen).HasColumnType("money");
        });
        ...
        modelBuilder.Entity<KategoriMenusu>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("KategoriMenusu");
        ...
        modelBuilder.Entity<OrderDetail>(entity =>
        {
            ...
            entity.ToTable("Order Details", tb => tb.HasTrigger("stockUpdater"));
        ...
        {
            entity.ToTable(tb => tb.HasTrigger("TR_DeleteProduct"));
